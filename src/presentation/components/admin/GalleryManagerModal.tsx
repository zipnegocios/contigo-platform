...
function SortableItem({
  ...
  return (
    ...
    >
      ...
      >
        <GripVertical className="w-[clamp(1rem,2vw,1.25rem)] h-[clamp(1rem,2vw,1.25rem)]" />
      </button>
      ...
      <div className="flex-1 min-w-0 space-y-1.5">
        <input
          ...
          className="w-full text-fluid-xs px-2.5 py-1.5 rounded-lg outline-none"
      ...
      <div className="flex-shrink-0 flex flex-col gap-1">
        <button
          ...
          title="Move up"
        >
          <ChevronUp className="w-[clamp(0.75rem,1.5vw,1rem)] h-[clamp(0.75rem,1.5vw,1rem)]" />
        </button>
        <button
          type="button"
          onClick={onMoveDown}
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <h2 className="text-fluid-lg font-semibold" style={{ color: 'var(--neutral-50)', fontFamily: 'var(--font-cormorant)' }}>
            Gallery Manager
          </h2>
        ...
        <div className="flex flex-1 min-h-0 overflow-hidden">
          ...
          >
            {localItems.length === 0 ? (
              ...
              >
                <p className="text-fluid-sm">No gallery items yet</p>
                <p className="text-fluid-xs mt-1">Add images from the library or upload new files</p>
              </div>
            ) : (
          ...
          <div className="flex-shrink-0 p-5 space-y-4" style={{ width: 220 }}>
            <p className="text-fluid-xs uppercase tracking-widest" style={{ color: 'var(--neutral-600)' }}>Add Media</p>

            <button
              type="button"
              onClick={() => setPickerOpen(true)}
              className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl text-fluid-sm font-medium transition-all"
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl text-fluid-sm font-medium transition-all disabled:opacity-60"
        ...
        >
          ...
          <div className="flex gap-3">
            <button
              type="button"
              onClick={onClose}
              className="px-5 py-2 rounded-lg text-fluid-sm font-medium"
            ...
            <button
              type="button"
              onClick={handleSave}
              className="px-5 py-2 rounded-lg text-fluid-sm font-semibold"
