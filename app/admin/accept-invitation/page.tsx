...
function AcceptInvitationForm() {
  ...
  if (!token) {
    return (
      <div className="text-center text-sm" style={{ color: '#2D2924' }}>
        ...
        <Link href="/admin/login" className="mt-4 inline-block text-xs font-semibold uppercase tracking-wide" style={{ color: '#C8A53C' }}>
          Back to sign in
        </Link>
      </div>
    )
  ...
  if (success) {
    return (
      <div className="text-center text-sm" style={{ color: '#2D2924' }}>
        <p>Account activated. Redirecting to sign in…</p>
      </div>
    )
  }
